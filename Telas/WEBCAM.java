...
public class WEBCAM extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagensTelas/Novo.png"))); // NOI18N
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagensTelas/foto.png"))); // NOI18N
...
//            LEVA_BYTES = bytes; // AQUI A IMAGEM ESTÃ� CONVERTIDA EM BYTES NO TAMANHO ORIGINAL

            ByteArrayInputStream is = new ByteArrayInputStream(bytes);
            BufferedImage imagem = ImageIO.read(is);
            
            int Nova_Largura = 500, Nova_Altura = 500; //AQUI EU DEFINO QUAL SERÃ� O NOVO TAMANHO PARA MINHA IMAGEM
...
//            ImageIO.write(new_img, "JPG", new File("C:\\fototeste.jpg"));
            ...
            LEVA_BYTES = buff2.toByteArray(); // AQUI A IMAGEM ESTÃ� CONVERTIDA EM BYTES NO TAMANHO PERSONALIZADO
...
private void INICIALIZA() {
        try {
//          dimensao_default = new Dimension(176, 144); //UTILIZO A DIMENSÃƒO DE MINHA PREFERÃŠNCIA
            dimensao_default = WebcamResolution.VGA.getSize();//UTILIZA A DIMENSÃƒO PADRÃƒO DA WEBCAM
            WEBCAM = Webcam.getDefault(); //UTILIZA A WEBCAM PADRÃƒO DO COMPUTADOR            
//          List list = Webcam.getWebcams();            
//          for (int i = 0; i < list.size(); i++) {
//          WEBCAM =  (Webcam) list.get(i); //UTILIZA A ÃšLTIMA WEBCAM ENCONTRADA, SE EXISTIR MAIS DE UMA PEGA A ÃšLTIMA
//          }
            WEBCAM.setViewSize(dimensao_default); 
                        
            for(Dimension dimensao : WEBCAM.getViewSizes()){ // AQUI EU CONSIGO SABER QUAIS SÃƒO RESOLUÃ‡Ã•ES SUPORTADA PELA WEBCAM
