...
public class TelaCadastroConformeMedico extends javax.swing.JFrame {
     ...
     */
    public TelaCadastroConformeMedico() {
        initComponents();
...
//    
    ...
    public void listarIntervalo() {
        ...
        model.setNumRows(0);
        String sql = "Select codigo,DataCadastro,Conforme from tb_conforme order by Conforme ASC";
        try {
    ...
    public void SalvarIntervalo() {
        Conexao conec = new Conexao();
        String sql = "insert into tb_conforme(DataCadastro,Conforme)values(?,?)";

        try {
            pst = Conexao.conector().prepareStatement(sql);
            pst.setDate(1, convertDateSalvar(txtData.getDate()));
            pst.setString(2, txtConforme.getText());
            pst.execute();
            JOptionPane.showMessageDialog(rootPane, " Conforme " + txtConforme.getText().toUpperCase() + " salvo com sucesso.", "Inclusão", JOptionPane.INFORMATION_MESSAGE,icon);
            listarIntervalo();
        } catch (SQLException error) {
            JOptionPane.showMessageDialog(null, error);
        } finally {
    ...
    public void alterarIntervalo() {
        Conexao conec = new Conexao();
        String sql = "update tb_conforme set DataCadastro=?,Conforme=? where codigo=?";
        ...
        try {
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(rootPane, " Conforme " + txtConforme.getText().toUpperCase() + " Atualizado com sucesso.", "Alteração", JOptionPane.INFORMATION_MESSAGE,icon);
            listarIntervalo();
        } catch (SQLException error) {
            JOptionPane.showMessageDialog(null, error);
        } finally {
    ...
    public void removerIntervalo() {
        Conexao conec = new Conexao();
        String sql = "delete from tb_conforme where codigo=?";

        try {
            pst = Conexao.conector().prepareStatement(sql);
            pst.setInt(1, Integer.parseInt(txtCodigo.getText()));
            pst.execute();
            JOptionPane.showMessageDialog(rootPane, " Conforme " + txtConforme.getText().toUpperCase() + " Excluido com sucesso.", "Exclusão", JOptionPane.INFORMATION_MESSAGE,iconExcluir);
            listarIntervalo();
        } catch (SQLException error) {
    ...
    public void mostrarItens() {
        ...
        txtConforme.setText(jTableIntervalos.getModel().getValueAt(seleciona, 2).toString());
    }
    ...
    private void initComponents() {
        ...
        txtConforme = new javax.swing.JTextField();
        ...
        jLabel3.setText("CONFORME:");

        txtConforme.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txtConforme.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        txtConforme.setEnabled(false);
        txtConforme.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtConformeFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtConformeFocusLost(evt);
            }
        });
        txtConforme.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtConformeKeyReleased(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtConforme, javax.swing.GroupLayout.PREFERRED_SIZE, 202, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtConforme, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtCodigo, txtConforme});
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtConforme.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Campo Conforme é obrigatório", "Atenção", JOptionPane.WARNING_MESSAGE);
            txtConforme.requestFocus();
            return;
        }
    ...
    private void txtConformeFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtConformeFocusGained
        txtConforme.setBackground(new Color(252, 233, 163));
    }//GEN-LAST:event_txtConformeFocusGained

    private void txtConformeFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtConformeFocusLost
        txtConforme.setBackground(new Color(255, 255, 255));
    }//GEN-LAST:event_txtConformeFocusLost
    ...
    private void txtConformeKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtConformeKeyReleased
       
    }//GEN-LAST:event_txtConformeKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroConformeMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroConformeMedico().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtConforme;
