...
public class TelaCadastroModoTomar extends javax.swing.JFrame {
...
//    
    ...
    public void listarIntervalo() {
        ...
        model.setNumRows(0);
        String sql = "Select codigo,DataCadastro,Tomar from tb_Modo_Tomar order by Tomar ASC";
        try {
    ...
    public void SalvarIntervalo() {
        Conexao conec = new Conexao();
        String sql = "insert into tb_Modo_Tomar(DataCadastro,Tomar)values(?,?)";

        try {
            pst = Conexao.conector().prepareStatement(sql);
            pst.setDate(1, convertDateSalvar(txtData.getDate()));
            pst.setString(2, txtComoTomar.getText());
            pst.execute();
            JOptionPane.showMessageDialog(rootPane, " Tomar " + txtComoTomar.getText().toUpperCase() + " salvo com sucesso.", "Inclusão", JOptionPane.INFORMATION_MESSAGE,icon);
            listarIntervalo();
        } catch (SQLException error) {
            JOptionPane.showMessageDialog(null, error);
        } finally {
    ...
    public void alterarIntervalo() {
        Conexao conec = new Conexao();
        String sql = "update tb_Modo_Tomar set DataCadastro=?,Tomar=? where codigo=?";
        ...
        try {
            ...
            pst.executeUpdate();
            JOptionPane.showMessageDialog(rootPane, " Tomar " + txtComoTomar.getText().toUpperCase() + " Atualizado com sucesso.", "Alteração", JOptionPane.INFORMATION_MESSAGE,icon);
            listarIntervalo();
        } catch (SQLException error) {
            JOptionPane.showMessageDialog(null, error);
        } finally {
    ...
    public void removerIntervalo() {
        Conexao conec = new Conexao();
        String sql = "delete from tb_Modo_Tomar where codigo=?";

        try {
            pst = Conexao.conector().prepareStatement(sql);
            pst.setInt(1, Integer.parseInt(txtCodigo.getText()));
            pst.execute();
            JOptionPane.showMessageDialog(rootPane, " Tomar " + txtComoTomar.getText().toUpperCase() + " Excluido com sucesso.", "Exclusão", JOptionPane.INFORMATION_MESSAGE,iconExcluir);
            listarIntervalo();
        } catch (SQLException error) {
    ...
    public void mostrarItens() {
        ...
        txtComoTomar.setText(jTableIntervalos.getModel().getValueAt(seleciona, 2).toString());
    }

    private void limpar() {
        txtCodigo.setText("");
        txtComoTomar.setText("");
    ...
    private void initComponents() {
        ...
        txtComoTomar = new javax.swing.JTextField();
        ...
        jLabel3.setText("COMO TOMAR:");

        txtComoTomar.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txtComoTomar.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        txtComoTomar.setEnabled(false);
        txtComoTomar.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtComoTomarFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                txtComoTomarFocusLost(evt);
            }
        });
        txtComoTomar.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtComoTomarKeyReleased(evt);
            }
        });
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtComoTomar, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtCodigo, txtComoTomar});

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 470, -1));
        ...
        getContentPane().add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 210, 470, -1));
        ...
        jTableIntervalos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Data Cadastro", "ComoTomar"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 470, 102));

        setSize(new java.awt.Dimension(504, 322));
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (txtComoTomar.getText().equals("")) {
            JOptionPane.showMessageDialog(rootPane, "Campo modo de tomar é obrigatório", "Atenção", JOptionPane.WARNING_MESSAGE);
            txtComoTomar.requestFocus();
            return;
        }
    ...
    private void txtComoTomarFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtComoTomarFocusGained
        txtComoTomar.setBackground(new Color(252, 233, 163));
    }//GEN-LAST:event_txtComoTomarFocusGained

    private void txtComoTomarFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtComoTomarFocusLost
        txtComoTomar.setBackground(new Color(255, 255, 255));
    }//GEN-LAST:event_txtComoTomarFocusLost
    ...
    private void txtComoTomarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtComoTomarKeyReleased
       
    }//GEN-LAST:event_txtComoTomarKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroModoTomar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroModoTomar().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtComoTomar;
